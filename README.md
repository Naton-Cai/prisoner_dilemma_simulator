...
One of the big things not implemented was proper health displays for each bugster entity. Fyrox 1.0.0-rc.1 change how rendering UI elements onto textures worked and the documentation has not been updated to match. Further experimentation will have to be done to properly implemnt this feature. Additionally, managing different viewport sizes is not that well-documented and has proven to be difficult for the game.
